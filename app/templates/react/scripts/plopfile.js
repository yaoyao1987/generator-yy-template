...
module.exports = function (plop) {
  plop.setGenerator('component', {
    ...
    actions: [
      {
        type: 'add',
        path: path.resolve(__dirname, '../src/components/{{kebabCase name}}/index.js'),
      ...
      },
      {
        ...
        path: path.resolve(
          __dirname,
          '../src/components/{{kebabCase name}}/{{kebabCase name}}.jsx',
        ),
      ...
      {
        type: 'add',
        path: path.resolve(__dirname, '../src/components/{{kebabCase name}}/style/index.js'),
      ...
      },
      {
        ...
        path: path.resolve(
          __dirname,
          '../src/components/{{kebabCase name}}/__tests__/index.test.jsx',
        ),
        templateFile: path.resolve(__dirname, '../templates/component/__tests__/index.test.hbs'),
      },
      {
        type: 'append',
        path: path.resolve(__dirname, '../src/components/index.js'),
